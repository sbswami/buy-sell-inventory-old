...
public class mySellListAdapter extends ArrayAdapter<String> {
    Activity context;
    String[] productName;
    String[] quantity;
    String[] buyPrice;
    ...
    public mySellListAdapter(Activity context, String[] productName, String[] quantity, String[] buyPrice, String[] sellPrice, String[] sellPrice2) {
        super(context,R.layout.sell_history_list,productName);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.sell_history_list,null,true);
