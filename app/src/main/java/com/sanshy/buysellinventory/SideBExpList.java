    ...
    protected void onStart() {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                historyPayListAdapter historyPayList = new historyPayListAdapter(SideBExpList.this,Date,remarkList,Amount);
        ...
        mRemarkRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(SideBExpList.this,android.R.layout.simple_spinner_dropdown_item, Arrays.asList(list));
