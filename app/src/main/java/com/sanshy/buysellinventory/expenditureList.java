...
tempo.clear();
        query.addListenerForSingleValueEvent( new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                historyPayListAdapter historyPayList = new historyPayListAdapter(expenditureList.this,Date,remarkList,Amount);
...
tempo.add(1);
        ...
        mRemarkRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(expenditureList.this,android.R.layout.simple_spinner_dropdown_item, Arrays.asList(list));
