...
public class SideBExpIncomeList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_side_bexp_list);
    ...
    protected void onStart() {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                historyPayListAdapter historyPayList = new historyPayListAdapter(SideBExpIncomeList.this,Date,remarkList,Amount);
        ...
        mRemarkRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(SideBExpIncomeList.this,android.R.layout.simple_spinner_dropdown_item, Arrays.asList(list));
    ...
    public void search(View view) { progressBar.setVisibility(View.VISIBLE);
